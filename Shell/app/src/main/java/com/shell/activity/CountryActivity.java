...
public class CountryActivity extends Activity {
    ...
    private void initView() {
        ...
        RelativeLayout rlFinish=findViewById(R.id.rlLeft);
        TextView  tvTitle=findViewById(R.id.tv_title);

        tvTitle.setText(R.string.country_f);
        rlFinish.setOnClickListener(new OnClickListener() {
            @Override
    ...
    private void setListener() {
        ...
        country_lv_countryList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long arg3) {
                ...
                Log.i("song", "countryName: + " + countryName + "countryNumber: " + countryNumber);
                finish();
