...
import static com.shell.updatedemo.utils.ToastUtils.showToast;

/**
 * Created by wangjungang on 25/11/2019.
 * E-Mail:811832241@qq.com
 */
public class TiBiFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_tibi_fragment, container, false);
    ...
    private void initData() {
        myBalance = getActivity().getIntent().getStringExtra("myBalance");
    ...
    private void initView() {
        ...
        underCardAdapter = new TiBiRecordAdapter(firstList, getActivity());
            ...
            switch (what) {
                ...
                case 3:
                    ...
                    if (tiBiResult.getResultCode().equals("999999")) {
                        window.dismiss();
                        Toast.makeText(getActivity(), tiBiResult.getResultDesc(), Toast.LENGTH_SHORT).show();
                        getTiBiData();
                    } else {
                        window.dismiss();
                        Toast.makeText(getActivity(), tiBiResult.getResultDesc(), Toast.LENGTH_SHORT).show();
    ...
    @OnClick({R.id.iv_sao, R.id.tv_all, R.id.btn_TiXian})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.iv_sao:
                //扫一扫

                MNScanManager.startScan(getActivity(), new MNScanCallback() {
                    @Override
    ...
    private void gotosetPayPwd() {
        View inflate = LayoutInflater.from(getActivity()).inflate(R.layout.popuwindow_set_pay_pwd, null, false);
        ...
        tvOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), JiaoYiActivity.class);
    ...
    private void showPopuwindow() {
        View inflate = LayoutInflater.from(getActivity()).inflate(R.layout.popu_newtibi, null, false);
        ...
        window.showAtLocation(LayoutInflater.from(getActivity()).inflate(R.layout.activity_zhiya, null), Gravity.CENTER, 0, 0);
    }
