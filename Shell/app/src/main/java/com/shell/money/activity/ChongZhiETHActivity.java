...
public class ChongZhiETHActivity extends BaseActivity {
    ...
    protected int getLayoutId() {
        return R.layout.activity_chongzhie_th;
    }
    ...
    OnResponseListener<JSONObject> responseListener = new OnResponseListener<JSONObject>() {
        ...
        public void onStart(int what) {
            if (myWaitDialog == null) {
                myWaitDialog = new MyWaitDialog(ChongZhiETHActivity.this);
                myWaitDialog.show();
            } else {
                myWaitDialog.show();
            }
        ...
        public void onSucceed(int what, Response<JSONObject> response) {
            LogonFailureUtil.gotoLoginActiviy(ChongZhiETHActivity.this, response.get().toString());
            Gson gson = new Gson();
            switch (what) {
                case 0:
    ...
    private void initViews() {
        chongZhiRecordAdapter = new ChongZhiRecordAdapter(ChongZhiETHActivity.this, firstList);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.rl_copy:
                ...
                Toast.makeText(ChongZhiETHActivity.this, getString(R.string.tv_hascopy), Toast.LENGTH_SHORT).show();
                break;
        }
    }
}
